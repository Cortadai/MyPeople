	...
	public static void main(String[] args) {
		try
        {
          ...
          // una cuenta de gmail.
            ...
            props.setProperty("mail.smtp.user", "rafaelrfp@gmail.com");
            ...
            message.setFrom(new InternetAddress("RAFAEL RODRIGUEZ FERNANDEZ <rafaelrfp@gmail.com>"));
            message.addRecipient(
                Message.RecipientType.TO,
                new InternetAddress("rafael.rodriguez@entelgy-ibai.com"));
            message.setSubject("INFORME DIARIO DE EMPLEADOS");
            message.setContent(multiParte);

            // Se envia el correo.
            Transport t = session.getTransport("smtp");
            t.connect("rafaelrfp@gmail.com", "gnrrebknszrqymmk");
