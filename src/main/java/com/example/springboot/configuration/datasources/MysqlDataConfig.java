...
public class MysqlDataConfig {
	...
	public LocalContainerEntityManagerFactoryBean mysqlEntityManagerFactory(
		...
		return mysqlEntityManagerFactoryBuilder.dataSource(mysqlDataSource)
				.packages("com.example.springboot.entity.security").persistenceUnit("mysqlDataSource")
				.properties(mysqlJpaProperties).build();
	}
